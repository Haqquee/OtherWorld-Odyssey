...
def get_visual_scene_description(scenario_text: str):
  prompt = f"In one line, give me a visual description of the setting from the following scenario (from the prespective of the protagonist). Scenario: {scenario_text}"
...
def classify_action(player_action: str):
